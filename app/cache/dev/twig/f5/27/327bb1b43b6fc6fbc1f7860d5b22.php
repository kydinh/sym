...
class __TwigTemplate_f527327bb1b43b6fc6fbc1f7860d5b22 extends Twig_Template
{
    ...
    ";
        // line 5
        echo $this->env->getExtension('http_kernel')->render($this->env->getExtension('routing')->getPath("_wdt", array("token" => (isset($context["token"]) ? $context["token"] : $this->getContext($context, "token")), "position" => "normal")));
        echo "
    ...
    <div id=\"content\">
        ...
        // line 56
        echo "                    ";
        echo $this->env->getExtension('http_kernel')->render($this->env->getExtension('routing')->getPath("_profiler_search_bar"));
        echo "
                    ";
        // line 57
